...
func TestTSDrizzleGenerator_Enums(t *testing.T) {
	...
	// Enum ordering is now the model's responsibility (Canonicalize), not the
	// generator's. Real schemas flow through Build -> Canonicalize; this
	// hand-built fixture must do the same for the sorted-output assertion.
	schema.Canonicalize()
